...
constexpr const char* APN_DEV_ADDRESS = "api.development.push.apple.com";
constexpr const char* APN_PROD_ADDRESS = "api.push.apple.com";
constexpr const char* APN_PORT = "443";
