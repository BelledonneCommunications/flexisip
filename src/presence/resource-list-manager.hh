...
public:
	...
	class FethListener : Listener{
		virtual void onResponse(const list<const belle_sip_header_address_t*> list) throw ();
	 ...
	 *
	 * */
	virtual void add(std::string& list_name,const list<const belle_sip_header_address_t*> entries, Listener& listener) throw ()=0;
