...
protected:
	virtual void onResponse(const std::shared_ptr<BranchInfo>& br,
	                        const std::shared_ptr<ResponseSipEvent>& event) override;
	virtual bool onNewRegister(const url_t* url, const std::string& uid) override;
