...
private:
	...
	public:
		...
		const std::string &bigUIInt() const noexcept {return mBigUInt;}
		const std::string &dateTime() const noexcept {return mDateTime;}
		const std::string &primaryKeyIncrementType() const noexcept {return mPrimaryKeyIncrementType;}
