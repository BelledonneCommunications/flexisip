...
/**
 * Same as BC_ASSERT_ENUM_EQUAL() but send an exception in addition of marking the test as failed.
 */
#define BC_HARD_ASSERT_ENUM_EQUAL(value, expected) BC_HARD_ASSERT_CPP_EQUAL(int(value), int(expected))
