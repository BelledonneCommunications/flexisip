...
#define LOGDV(thefmt, theargs)                                                                                         \
	flexisip::log::formated_log_with_severity(flexisip::log::level::debug, (thefmt), (theargs))
...
#define LOG_SCOPED_THREAD(key, value) BOOST_LOG_SCOPED_THREAD_TAG((key), (value));
...
#define LOG_SCOPED_THREAD(key, value) BOOST_LOG_SCOPED_THREAD_TAG((key), string, (value));
