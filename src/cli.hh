...
public:
	CommandLineInterface(const std::string& name, const std::shared_ptr<sofiasip::SuRoot>& root);
...
public:
	explicit ProxyCommandLineInterface(const std::shared_ptr<Agent>& agent);
