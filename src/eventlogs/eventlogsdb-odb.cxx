...
namespace odb
{
  ...
  "`lm_sd_payload_desc`, "
  "`lm_sd_sample_rate`, "
  "`lm_sd_frame_duration`, "
  "`lm_sd_fmtp`, "
  "`lm_sd_packet_loss_concealment`, "
  "`lm_jb_adaptive`, "
  "`lm_jb_nominal`, "
  "`lm_jb_max`, "
  "`lm_jb_abs_max`, "
  "`lm_pl_network_packet_loss_rate`, "
  "`lm_pl_jitter_buffer_discard_rate`, "
  "`lm_d_round_trip_delay`, "
  "`lm_d_end_system_delay`, "
  "`lm_d_symm_one_way_delay`, "
  "`lm_d_interarrival_jitter`, "
  "`lm_d_mean_abs_jitter`, "
  "`lm_s_level`, "
  "`lm_s_noise_level`, "
  "`lm_qe_moslq`, "
  "`lm_qe_moscq`, "
  ...
  "`rm_sd_payload_desc`, "
  "`rm_sd_sample_rate`, "
  "`rm_sd_frame_duration`, "
  "`rm_sd_fmtp`, "
  "`rm_sd_packet_loss_concealment`, "
  "`rm_jb_adaptive`, "
  "`rm_jb_nominal`, "
  "`rm_jb_max`, "
  "`rm_jb_abs_max`, "
  "`rm_pl_network_packet_loss_rate`, "
  "`rm_pl_jitter_buffer_discard_rate`, "
  "`rm_d_round_trip_delay`, "
  "`rm_d_end_system_delay`, "
  "`rm_d_symm_one_way_delay`, "
  "`rm_d_interarrival_jitter`, "
  "`rm_d_mean_abs_jitter`, "
  "`rm_s_level`, "
  "`rm_s_noise_level`, "
  "`rm_qe_moslq`, "
  "`rm_qe_moscq`, "
  ...
  const char* const access::object_traits_impl< ::CallQualityStatisticsLogDb, id_mysql >::find_statements[] =
  {
    ...
    "`CallQualityStatisticsLog`.`la_id`, "
    "`CallQualityStatisticsLog`.`la_ip`, "
    "`CallQualityStatisticsLog`.`la_port`, "
    "`CallQualityStatisticsLog`.`la_ssrc`, "
    "`CallQualityStatisticsLog`.`la_group`, "
    "`CallQualityStatisticsLog`.`la_mac`, "
    "`CallQualityStatisticsLog`.`ra_id`, "
    "`CallQualityStatisticsLog`.`ra_ip`, "
    "`CallQualityStatisticsLog`.`ra_port`, "
    "`CallQualityStatisticsLog`.`ra_ssrc`, "
    "`CallQualityStatisticsLog`.`ra_group`, "
    "`CallQualityStatisticsLog`.`ra_mac`, "
    "`CallQualityStatisticsLog`.`lm_ts_start`, "
    "`CallQualityStatisticsLog`.`lm_ts_stop`, "
    "`CallQualityStatisticsLog`.`lm_sd_payload_type`, "
    "`CallQualityStatisticsLog`.`lm_sd_payload_desc`, "
    "`CallQualityStatisticsLog`.`lm_sd_sample_rate`, "
    "`CallQualityStatisticsLog`.`lm_sd_frame_duration`, "
    "`CallQualityStatisticsLog`.`lm_sd_fmtp`, "
    "`CallQualityStatisticsLog`.`lm_sd_packet_loss_concealment`, "
    "`CallQualityStatisticsLog`.`lm_jb_adaptive`, "
    "`CallQualityStatisticsLog`.`lm_jb_nominal`, "
    "`CallQualityStatisticsLog`.`lm_jb_max`, "
    "`CallQualityStatisticsLog`.`lm_jb_abs_max`, "
    "`CallQualityStatisticsLog`.`lm_pl_network_packet_loss_rate`, "
    "`CallQualityStatisticsLog`.`lm_pl_jitter_buffer_discard_rate`, "
    "`CallQualityStatisticsLog`.`lm_d_round_trip_delay`, "
    "`CallQualityStatisticsLog`.`lm_d_end_system_delay`, "
    "`CallQualityStatisticsLog`.`lm_d_symm_one_way_delay`, "
    "`CallQualityStatisticsLog`.`lm_d_interarrival_jitter`, "
    "`CallQualityStatisticsLog`.`lm_d_mean_abs_jitter`, "
    "`CallQualityStatisticsLog`.`lm_s_level`, "
    "`CallQualityStatisticsLog`.`lm_s_noise_level`, "
    "`CallQualityStatisticsLog`.`lm_qe_moslq`, "
    "`CallQualityStatisticsLog`.`lm_qe_moscq`, "
    "`CallQualityStatisticsLog`.`lm_user_agent`, "
    "`CallQualityStatisticsLog`.`rm_ts_start`, "
    "`CallQualityStatisticsLog`.`rm_ts_stop`, "
    "`CallQualityStatisticsLog`.`rm_sd_payload_type`, "
    "`CallQualityStatisticsLog`.`rm_sd_payload_desc`, "
    "`CallQualityStatisticsLog`.`rm_sd_sample_rate`, "
    "`CallQualityStatisticsLog`.`rm_sd_frame_duration`, "
    "`CallQualityStatisticsLog`.`rm_sd_fmtp`, "
    "`CallQualityStatisticsLog`.`rm_sd_packet_loss_concealment`, "
    "`CallQualityStatisticsLog`.`rm_jb_adaptive`, "
    "`CallQualityStatisticsLog`.`rm_jb_nominal`, "
    "`CallQualityStatisticsLog`.`rm_jb_max`, "
    "`CallQualityStatisticsLog`.`rm_jb_abs_max`, "
    "`CallQualityStatisticsLog`.`rm_pl_network_packet_loss_rate`, "
    "`CallQualityStatisticsLog`.`rm_pl_jitter_buffer_discard_rate`, "
    "`CallQualityStatisticsLog`.`rm_d_round_trip_delay`, "
    "`CallQualityStatisticsLog`.`rm_d_end_system_delay`, "
    "`CallQualityStatisticsLog`.`rm_d_symm_one_way_delay`, "
    "`CallQualityStatisticsLog`.`rm_d_interarrival_jitter`, "
    "`CallQualityStatisticsLog`.`rm_d_mean_abs_jitter`, "
    "`CallQualityStatisticsLog`.`rm_s_level`, "
    "`CallQualityStatisticsLog`.`rm_s_noise_level`, "
    "`CallQualityStatisticsLog`.`rm_qe_moslq`, "
    "`CallQualityStatisticsLog`.`rm_qe_moscq`, "
    "`CallQualityStatisticsLog`.`rm_user_agent`, "
...
namespace odb
{
      ...
      switch (pass)
      {
        case 1:
        {
          ...
          db.execute ("CREATE TABLE `CallQualityStatisticsLog` (\n"
                      ...
                      "  `la_ssrc` INT UNSIGNED NOT NULL,\n"
                      "  `la_group` TEXT NOT NULL,\n"
                      "  `la_mac` TEXT NOT NULL,\n"
                      "  `ra_id` TEXT NOT NULL,\n"
                      "  `ra_ip` TEXT NOT NULL,\n"
                      "  `ra_port` INT NOT NULL,\n"
                      "  `ra_ssrc` INT UNSIGNED NOT NULL,\n"
                      "  `ra_group` TEXT NOT NULL,\n"
                      "  `ra_mac` TEXT NOT NULL,\n"
                      "  `lm_ts_start` BIGINT NOT NULL,\n"
                      "  `lm_ts_stop` BIGINT NOT NULL,\n"
                      "  `lm_sd_payload_type` INT NOT NULL,\n"
                      "  `lm_sd_payload_desc` TEXT NOT NULL,\n"
                      "  `lm_sd_sample_rate` INT NOT NULL,\n"
                      "  `lm_sd_frame_duration` INT NOT NULL,\n"
                      "  `lm_sd_fmtp` TEXT NOT NULL,\n"
                      "  `lm_sd_packet_loss_concealment` INT NOT NULL,\n"
                      "  `lm_jb_adaptive` INT NOT NULL,\n"
                      "  `lm_jb_nominal` INT NOT NULL,\n"
                      "  `lm_jb_max` INT NOT NULL,\n"
                      "  `lm_jb_abs_max` INT NOT NULL,\n"
                      "  `lm_pl_network_packet_loss_rate` FLOAT NOT NULL,\n"
                      "  `lm_pl_jitter_buffer_discard_rate` FLOAT NOT NULL,\n"
                      "  `lm_d_round_trip_delay` INT NOT NULL,\n"
                      "  `lm_d_end_system_delay` INT NOT NULL,\n"
                      "  `lm_d_symm_one_way_delay` INT NOT NULL,\n"
                      "  `lm_d_interarrival_jitter` INT NOT NULL,\n"
                      "  `lm_d_mean_abs_jitter` INT NOT NULL,\n"
                      "  `lm_s_level` INT NOT NULL,\n"
                      "  `lm_s_noise_level` INT NOT NULL,\n"
                      "  `lm_qe_moslq` FLOAT NOT NULL,\n"
                      "  `lm_qe_moscq` FLOAT NOT NULL,\n"
                      "  `lm_user_agent` TEXT NOT NULL,\n"
                      "  `rm_ts_start` BIGINT NOT NULL,\n"
                      "  `rm_ts_stop` BIGINT NOT NULL,\n"
                      "  `rm_sd_payload_type` INT NOT NULL,\n"
                      "  `rm_sd_payload_desc` TEXT NOT NULL,\n"
                      "  `rm_sd_sample_rate` INT NOT NULL,\n"
                      "  `rm_sd_frame_duration` INT NOT NULL,\n"
                      "  `rm_sd_fmtp` TEXT NOT NULL,\n"
                      "  `rm_sd_packet_loss_concealment` INT NOT NULL,\n"
                      "  `rm_jb_adaptive` INT NOT NULL,\n"
                      "  `rm_jb_nominal` INT NOT NULL,\n"
                      "  `rm_jb_max` INT NOT NULL,\n"
                      "  `rm_jb_abs_max` INT NOT NULL,\n"
                      "  `rm_pl_network_packet_loss_rate` FLOAT NOT NULL,\n"
                      "  `rm_pl_jitter_buffer_discard_rate` FLOAT NOT NULL,\n"
                      "  `rm_d_round_trip_delay` INT NOT NULL,\n"
                      "  `rm_d_end_system_delay` INT NOT NULL,\n"
                      "  `rm_d_symm_one_way_delay` INT NOT NULL,\n"
                      "  `rm_d_interarrival_jitter` INT NOT NULL,\n"
                      "  `rm_d_mean_abs_jitter` INT NOT NULL,\n"
                      "  `rm_s_level` INT NOT NULL,\n"
                      "  `rm_s_noise_level` INT NOT NULL,\n"
                      "  `rm_qe_moslq` FLOAT NOT NULL,\n"
                      "  `rm_qe_moscq` FLOAT NOT NULL,\n"
                      "  `rm_user_agent` TEXT NOT NULL,\n"
  ...
  static bool
  migrate_schema_4 (database& db, unsigned short pass, bool pre)
  {
    ODB_POTENTIALLY_UNUSED (db);
    ODB_POTENTIALLY_UNUSED (pass);
    ODB_POTENTIALLY_UNUSED (pre);
    ...
    if (pre)
    {
      switch (pass)
      {
        ...
        {
          db.execute ("ALTER TABLE `CallQualityStatisticsLog`\n"
                      "  ADD COLUMN `la_id` TEXT NULL,\n"
                      "  ADD COLUMN `la_ip` TEXT NULL,\n"
                      "  ADD COLUMN `la_port` INT NULL,\n"
                      "  ADD COLUMN `la_ssrc` INT UNSIGNED NULL,\n"
                      "  ADD COLUMN `la_group` TEXT NULL,\n"
                      "  ADD COLUMN `la_mac` TEXT NULL,\n"
                      "  ADD COLUMN `ra_id` TEXT NULL,\n"
                      "  ADD COLUMN `ra_ip` TEXT NULL,\n"
                      "  ADD COLUMN `ra_port` INT NULL,\n"
                      "  ADD COLUMN `ra_ssrc` INT UNSIGNED NULL,\n"
                      "  ADD COLUMN `ra_group` TEXT NULL,\n"
                      "  ADD COLUMN `ra_mac` TEXT NULL,\n"
                      "  ADD COLUMN `lm_ts_start` BIGINT NULL,\n"
                      "  ADD COLUMN `lm_ts_stop` BIGINT NULL,\n"
                      "  ADD COLUMN `lm_sd_payload_type` INT NULL,\n"
                      "  ADD COLUMN `lm_sd_payload_desc` TEXT NULL,\n"
                      "  ADD COLUMN `lm_sd_sample_rate` INT NULL,\n"
                      "  ADD COLUMN `lm_sd_frame_duration` INT NULL,\n"
                      "  ADD COLUMN `lm_sd_fmtp` TEXT NULL,\n"
                      "  ADD COLUMN `lm_sd_packet_loss_concealment` INT NULL,\n"
                      "  ADD COLUMN `lm_jb_adaptive` INT NULL,\n"
                      "  ADD COLUMN `lm_jb_nominal` INT NULL,\n"
                      "  ADD COLUMN `lm_jb_max` INT NULL,\n"
                      "  ADD COLUMN `lm_jb_abs_max` INT NULL,\n"
                      "  ADD COLUMN `lm_pl_network_packet_loss_rate` FLOAT NULL,\n"
                      "  ADD COLUMN `lm_pl_jitter_buffer_discard_rate` FLOAT NULL,\n"
                      "  ADD COLUMN `lm_d_round_trip_delay` INT NULL,\n"
                      "  ADD COLUMN `lm_d_end_system_delay` INT NULL,\n"
                      "  ADD COLUMN `lm_d_symm_one_way_delay` INT NULL,\n"
                      "  ADD COLUMN `lm_d_interarrival_jitter` INT NULL,\n"
                      "  ADD COLUMN `lm_d_mean_abs_jitter` INT NULL,\n"
                      "  ADD COLUMN `lm_s_level` INT NULL,\n"
                      "  ADD COLUMN `lm_s_noise_level` INT NULL,\n"
                      "  ADD COLUMN `lm_qe_moslq` FLOAT NULL,\n"
                      "  ADD COLUMN `lm_qe_moscq` FLOAT NULL,\n"
                      "  ADD COLUMN `lm_user_agent` TEXT NULL,\n"
                      "  ADD COLUMN `rm_ts_start` BIGINT NULL,\n"
                      "  ADD COLUMN `rm_ts_stop` BIGINT NULL,\n"
                      "  ADD COLUMN `rm_sd_payload_type` INT NULL,\n"
                      "  ADD COLUMN `rm_sd_payload_desc` TEXT NULL,\n"
                      "  ADD COLUMN `rm_sd_sample_rate` INT NULL,\n"
                      "  ADD COLUMN `rm_sd_frame_duration` INT NULL,\n"
                      "  ADD COLUMN `rm_sd_fmtp` TEXT NULL,\n"
                      "  ADD COLUMN `rm_sd_packet_loss_concealment` INT NULL,\n"
                      "  ADD COLUMN `rm_jb_adaptive` INT NULL,\n"
                      "  ADD COLUMN `rm_jb_nominal` INT NULL,\n"
                      "  ADD COLUMN `rm_jb_max` INT NULL,\n"
                      "  ADD COLUMN `rm_jb_abs_max` INT NULL,\n"
                      "  ADD COLUMN `rm_pl_network_packet_loss_rate` FLOAT NULL,\n"
                      "  ADD COLUMN `rm_pl_jitter_buffer_discard_rate` FLOAT NULL,\n"
                      "  ADD COLUMN `rm_d_round_trip_delay` INT NULL,\n"
                      "  ADD COLUMN `rm_d_end_system_delay` INT NULL,\n"
                      "  ADD COLUMN `rm_d_symm_one_way_delay` INT NULL,\n"
                      "  ADD COLUMN `rm_d_interarrival_jitter` INT NULL,\n"
                      "  ADD COLUMN `rm_d_mean_abs_jitter` INT NULL,\n"
                      "  ADD COLUMN `rm_s_level` INT NULL,\n"
                      "  ADD COLUMN `rm_s_noise_level` INT NULL,\n"
                      "  ADD COLUMN `rm_qe_moslq` FLOAT NULL,\n"
                      "  ADD COLUMN `rm_qe_moscq` FLOAT NULL,\n"
                      "  ADD COLUMN `rm_user_agent` TEXT NULL");
          return true;
        }
        case 2:
        {
    ...
    else
    {
      switch (pass)
      {
        ...
        {
          db.execute ("ALTER TABLE `CallQualityStatisticsLog`\n"
                      "  MODIFY COLUMN `la_id` TEXT NOT NULL,\n"
                      "  MODIFY COLUMN `la_ip` TEXT NOT NULL,\n"
                      "  MODIFY COLUMN `la_port` INT NOT NULL,\n"
                      "  MODIFY COLUMN `la_ssrc` INT UNSIGNED NOT NULL,\n"
                      "  MODIFY COLUMN `la_group` TEXT NOT NULL,\n"
                      "  MODIFY COLUMN `la_mac` TEXT NOT NULL,\n"
                      "  MODIFY COLUMN `ra_id` TEXT NOT NULL,\n"
                      "  MODIFY COLUMN `ra_ip` TEXT NOT NULL,\n"
                      "  MODIFY COLUMN `ra_port` INT NOT NULL,\n"
                      "  MODIFY COLUMN `ra_ssrc` INT UNSIGNED NOT NULL,\n"
                      "  MODIFY COLUMN `ra_group` TEXT NOT NULL,\n"
                      "  MODIFY COLUMN `ra_mac` TEXT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_ts_start` BIGINT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_ts_stop` BIGINT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_sd_payload_type` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_sd_payload_desc` TEXT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_sd_sample_rate` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_sd_frame_duration` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_sd_fmtp` TEXT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_sd_packet_loss_concealment` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_jb_adaptive` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_jb_nominal` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_jb_max` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_jb_abs_max` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_pl_network_packet_loss_rate` FLOAT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_pl_jitter_buffer_discard_rate` FLOAT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_d_round_trip_delay` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_d_end_system_delay` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_d_symm_one_way_delay` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_d_interarrival_jitter` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_d_mean_abs_jitter` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_s_level` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_s_noise_level` INT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_qe_moslq` FLOAT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_qe_moscq` FLOAT NOT NULL,\n"
                      "  MODIFY COLUMN `lm_user_agent` TEXT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_ts_start` BIGINT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_ts_stop` BIGINT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_sd_payload_type` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_sd_payload_desc` TEXT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_sd_sample_rate` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_sd_frame_duration` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_sd_fmtp` TEXT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_sd_packet_loss_concealment` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_jb_adaptive` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_jb_nominal` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_jb_max` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_jb_abs_max` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_pl_network_packet_loss_rate` FLOAT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_pl_jitter_buffer_discard_rate` FLOAT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_d_round_trip_delay` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_d_end_system_delay` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_d_symm_one_way_delay` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_d_interarrival_jitter` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_d_mean_abs_jitter` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_s_level` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_s_noise_level` INT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_qe_moslq` FLOAT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_qe_moscq` FLOAT NOT NULL,\n"
                      "  MODIFY COLUMN `rm_user_agent` TEXT NOT NULL,\n"
                      "  DROP COLUMN `local_addr_id`,\n"
                      "  DROP COLUMN `local_addr_ip`,\n"
                      "  DROP COLUMN `local_addr_port`,\n"
                      "  DROP COLUMN `local_addr_ssrc`,\n"
                      "  DROP COLUMN `local_addr_group`,\n"
                      "  DROP COLUMN `local_addr_mac`,\n"
                      "  DROP COLUMN `remote_addr_id`,\n"
                      "  DROP COLUMN `remote_addr_ip`,\n"
                      "  DROP COLUMN `remote_addr_port`,\n"
                      "  DROP COLUMN `remote_addr_ssrc`,\n"
                      "  DROP COLUMN `remote_addr_group`,\n"
                      "  DROP COLUMN `remote_addr_mac`,\n"
                      "  DROP COLUMN `local_metrics_ts_start`,\n"
                      "  DROP COLUMN `local_metrics_ts_stop`,\n"
                      "  DROP COLUMN `local_metrics_sd_payload_type`,\n"
                      "  DROP COLUMN `local_metrics_sd_payload_desc`,\n"
                      "  DROP COLUMN `local_metrics_sd_sample_rate`,\n"
                      "  DROP COLUMN `local_metrics_sd_frame_duration`,\n"
                      "  DROP COLUMN `local_metrics_sd_fmtp`,\n"
                      "  DROP COLUMN `local_metrics_sd_packet_loss_concealment`,\n"
                      "  DROP COLUMN `local_metrics_jb_adaptive`,\n"
                      "  DROP COLUMN `local_metrics_jb_nominal`,\n"
                      "  DROP COLUMN `local_metrics_jb_max`,\n"
                      "  DROP COLUMN `local_metrics_jb_abs_max`,\n"
                      "  DROP COLUMN `local_metrics_pl_network_packet_loss_rate`,\n"
                      "  DROP COLUMN `local_metrics_pl_jitter_buffer_discard_rate`,\n"
                      "  DROP COLUMN `local_metrics_d_round_trip_delay`,\n"
                      "  DROP COLUMN `local_metrics_d_end_system_delay`,\n"
                      "  DROP COLUMN `local_metrics_d_symm_one_way_delay`,\n"
                      "  DROP COLUMN `local_metrics_d_interarrival_jitter`,\n"
                      "  DROP COLUMN `local_metrics_d_mean_abs_jitter`,\n"
                      "  DROP COLUMN `local_metrics_s_level`,\n"
                      "  DROP COLUMN `local_metrics_s_noise_level`,\n"
                      "  DROP COLUMN `local_metrics_qe_moslq`,\n"
                      "  DROP COLUMN `local_metrics_qe_moscq`,\n"
                      "  DROP COLUMN `remote_metrics_ts_start`,\n"
                      "  DROP COLUMN `remote_metrics_ts_stop`,\n"
                      "  DROP COLUMN `remote_metrics_sd_payload_type`,\n"
                      "  DROP COLUMN `remote_metrics_sd_payload_desc`,\n"
                      "  DROP COLUMN `remote_metrics_sd_sample_rate`,\n"
                      "  DROP COLUMN `remote_metrics_sd_frame_duration`,\n"
                      "  DROP COLUMN `remote_metrics_sd_fmtp`,\n"
                      "  DROP COLUMN `remote_metrics_sd_packet_loss_concealment`,\n"
                      "  DROP COLUMN `remote_metrics_jb_adaptive`,\n"
                      "  DROP COLUMN `remote_metrics_jb_nominal`,\n"
                      "  DROP COLUMN `remote_metrics_jb_max`,\n"
                      "  DROP COLUMN `remote_metrics_jb_abs_max`,\n"
                      "  DROP COLUMN `remote_metrics_pl_network_packet_loss_rate`,\n"
                      "  DROP COLUMN `remote_metrics_pl_jitter_buffer_discard_rate`,\n"
                      "  DROP COLUMN `remote_metrics_d_round_trip_delay`,\n"
                      "  DROP COLUMN `remote_metrics_d_end_system_delay`,\n"
                      "  DROP COLUMN `remote_metrics_d_symm_one_way_delay`,\n"
                      "  DROP COLUMN `remote_metrics_d_interarrival_jitter`,\n"
                      "  DROP COLUMN `remote_metrics_d_mean_abs_jitter`,\n"
                      "  DROP COLUMN `remote_metrics_s_level`,\n"
                      "  DROP COLUMN `remote_metrics_s_noise_level`,\n"
                      "  DROP COLUMN `remote_metrics_qe_moslq`,\n"
                      "  DROP COLUMN `remote_metrics_qe_moscq`,\n"
                      "  DROP COLUMN `local_metrics_user_agent`,\n"
                      "  DROP COLUMN `remote_metrics_user_agent`");
          db.execute ("UPDATE `schema_version`\n"
                      "  SET `migration` = 0\n"
                      "  WHERE `name` = ''");
          return false;
