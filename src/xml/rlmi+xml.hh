...
namespace Xsd
{
  namespace Rlmi
  {
    class List: public ::Xsd::XmlSchema::Type
    {
      public:
      // name
      //
      typedef ::Xsd::Rlmi::Name NameType;
      ...
      // resource
      //
      typedef ::Xsd::Rlmi::Resource ResourceType;
      ...
      // version
      //
      typedef ::Xsd::XmlSchema::UnsignedInt VersionType;
      ...
      // fullState
      //
      typedef ::Xsd::XmlSchema::Boolean FullStateType;
      ...
      // cid
      //
      typedef ::Xsd::XmlSchema::String CidType;
    ...
    class Resource: public ::Xsd::XmlSchema::Type
    {
      public:
      // name
      //
      ...
      // instance
      //
      typedef ::Xsd::Rlmi::Instance InstanceType;
    ...
    class Instance: public ::Xsd::XmlSchema::Type
    {
      public:
      // any
      //
      ...
      // state
      //
      typedef ::Xsd::Rlmi::State StateType;
      ...
      // reason
      //
      typedef ::Xsd::XmlSchema::String ReasonType;
    ...
    class Name: public ::Xsd::XmlSchema::String
    {
      public:
      // lang
      //
      ...
      Name (const ::Xsd::XmlSchema::String&);
...
namespace Xsd
{
  namespace Rlmi
  {
    ...
    serializeList (const ::Xsd::Rlmi::List& x, 
                   const ::Xsd::XmlSchema::NamespaceInfomap& m = ::Xsd::XmlSchema::NamespaceInfomap (),
                   ::Xsd::XmlSchema::Flags f = 0);
    ...
    ::Xsd::XmlSchema::dom::unique_ptr< ::xercesc::DOMDocument >
    serializeResource (const ::Xsd::Rlmi::Resource& x, 
                       const ::Xsd::XmlSchema::NamespaceInfomap& m = ::Xsd::XmlSchema::NamespaceInfomap (),
                       ::Xsd::XmlSchema::Flags f = 0);
    ...
    ::Xsd::XmlSchema::dom::unique_ptr< ::xercesc::DOMDocument >
    serializeInstance (const ::Xsd::Rlmi::Instance& x, 
                       const ::Xsd::XmlSchema::NamespaceInfomap& m = ::Xsd::XmlSchema::NamespaceInfomap (),
                       ::Xsd::XmlSchema::Flags f = 0);
    ...
    ::Xsd::XmlSchema::dom::unique_ptr< ::xercesc::DOMDocument >
    serializeName (const ::Xsd::Rlmi::Name& x, 
                   const ::Xsd::XmlSchema::NamespaceInfomap& m = ::Xsd::XmlSchema::NamespaceInfomap (),
                   ::Xsd::XmlSchema::Flags f = 0);
