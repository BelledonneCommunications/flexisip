...
std::ostream& operator<<(std::ostream& os, const flexisip::PushParam& pushParam) const noexcept;
std::ostream& operator<<(std::ostream& os, const flexisip::PushParamList& pushParamList) const noexcept;
