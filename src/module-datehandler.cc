...
protected:
	virtual void onDeclare(GenericStruct * module_config){
		ConfigItemDescriptor items[]={
			{	String		,	"assign-date-command"		,	"Path to script to assign Date to system. The date is passed as first argument of the command, as number of seconds since January 1st, 1900.",		""	},
			config_item_end
		};
