...
TlsConnection::TlsConnection(const string& host, const string& port, const SSL_METHOD* method) noexcept
...
TlsConnection::TlsConnection(const string& host, const string& port, SSLCtxUniquePtr&& ctx) noexcept
