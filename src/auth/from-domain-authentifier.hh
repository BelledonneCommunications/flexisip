...
class FromDomainAuthentifier : public Authentifier {
public:
	template <typename T>
	FromDomainAuthentifier(T&& trustedDomains) : mTrustedDomains{std::forward<T>(trustedDomains)} {}
...
private:
	...
	std::vector<std::string> mTrustedDomains{};
};
