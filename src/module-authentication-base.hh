...
protected:
	 ...
	 */
	virtual FlexisipAuthModuleBase *createAuthModule(const std::string &domain) = 0;
	virtual FlexisipAuthModuleBase *createAuthModule(const std::string &domain, int nonceExpire) = 0;
	/**
