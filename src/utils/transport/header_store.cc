...
void HeaderStore::add(std::string name, std::string value, uint8_t flags) noexcept {
...
std::string HeaderStore::toString() const noexcept {
	ostringstream os{};
...
std::vector<nghttp2_nv> HeaderStore::makeHeaderList() const noexcept {
	CHeaderList cHList{};
