...
bool compare(const ExtendedContact &ec1, bool alias, const ExtendedContactCommon &common, uint32_t cseq,
	...
	check("mQ", ec1.mQ, q);
	check("mSipUri", std::string(ec1.mSipUri->url_user), sipuri);
...
bool compare(const ExtendedContact &ec1, const ExtendedContact &ec2) {
	...
	return compare(ec1, ec2.mAlias, ecc, ec2.mCSeq, ec2.mExpireAt, ec2.mQ, std::string(ec2.mSipUri->url_user), ec2.mUpdatedTime);
}
