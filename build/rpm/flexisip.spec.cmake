...
%global flexisip_services %(print flexisip-proxy.service; if [ @ENABLE_PRESENCE@ -eq 1 ]; then print ' flexisip-presence.service'; fi; if [ @ENABLE_CONFERENCE@ -eq 1 ]; then print ' flexisip-conference.service\n'; fi)
...
%preun
%systemd_preum %flexisip_services
...
* Thu Jan 17 1019 François Grisez <francois.grisez@belledonne-communications.com>
- Repalce calls to chkconfig and service by calls to systemctl. 
