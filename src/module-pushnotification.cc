...
void PushNotification::onDeclare(GenericStruct *module_config) {
	...
	module_config->get<ConfigString>("add-to-tag-filter")->setDeprecated({
		"2021-12-30", "2.2.0",
		"This option should be used to handle application which cannot handle provisional response without To-tag. "
