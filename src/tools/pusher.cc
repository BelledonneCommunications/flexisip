...
int main(int argc, char *argv[]) {
...

	{
		...
		if (args.pntype == "apple" || args.standardPushParams.pnProvider == "apns" || args.standardPushParams.pnProvider == "apns.dev") {
			service.setupiOSClient(args.prefix + "/apn", "");
		} else if (args.pntype == "firebase" || args.standardPushParams.pnProvider == "fcm") {
