...
if (EXISTS ${LINPHONESDK_SOURCE_DIR})
	include(${LINPHONESDK_SOURCE_DIR}/bctoolbox/cmake/BcToolboxCMakeUtils.cmake)
	...
	bc_generate_rpm_specfile("${PROJECT_SOURCE_DIR}/build/rpm/flexisip.spec.cmake" "${PROJECT_SOURCE_DIR}/flexisip.spec")
endif()
