...
ConferenceServer::Init::Init() {
	ConfigItemDescriptor items[] = {
	    ...
	    {StringList, "nat-addresses",
	     "Public host name or IP addresses of the conference server machine. Configuring this property is required when the conference server "
	     ...
	     "If no hostname is given, the v4 and v6 IP address can be listed separated by whitespaces, in any order. It is not possible "
