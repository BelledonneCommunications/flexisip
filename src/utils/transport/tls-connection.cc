...
TlsConnection::TlsConnection(const string& host, const string& port, const SSL_METHOD* method,
							 const bool mustBeHttp2) noexcept
...
TlsConnection::TlsConnection(const string& host, const string& port, SSLCtxUniquePtr&& ctx,
							 const bool mustBeHttp2) noexcept
	: mCtx{move(ctx)}, mHost{host}, mPort{port}, mMustBeHttp2{mustBeHttp2} {
}
