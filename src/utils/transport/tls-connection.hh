...
class TlsConnection {
  public:
	...
	TlsConnection(const std::string& host, const std::string& port, const SSL_METHOD* method, const bool mustBeHttp2 = false) noexcept;
	TlsConnection(const std::string& host, const std::string& port, SSLCtxUniquePtr&& ctx, const bool mustBeHttp2 = false) noexcept;
