    ...
    [](GenericStruct& moduleConfig) {
	    ...
	    ConfigItemDescriptor items[] = {
	        ...
	        {DurationS, "message-time-to-live",
	         ...
	         "0"},
	        {Integer, "max-queue-size", "Maximum number of notifications queued for each push notification service",
	         "100"},
	        ...
	        {String, "apple-certificate-dir",
	         "Path to directory where to find Apple Push Notification service certificates. They should bear the appid "
	         "of "
	        ...
	        {Integer, "firebase-default-refresh-interval",
	         "Default interval in seconds to execute the access token refresh operation in the event that the access "
	         "token "
	        ...
	        {String, "external-push-uri",
	         ...
	         "\n"
	         " - $type: Represents the type of push notification, distinguishing between Apple ('apple') and Android "
	         "('firebase') notifications.\n"
	         " - $token: Corresponds to the value of the 'pn-prid' push parameter. For Apple devices, 'pn-prid' may "
	         "contain multiple tokens depending on the notification type ('remote' or 'voip'). In such cases, $token "
	         ...
	         " - $app-id: An identifier for the application. On Android, it matches the value of 'pn-param'. On Apple, "
	         "it matches the string between the first and last dot ('.') of 'pn-param'. For example, if 'pn-param' is "
	         ...
	         "\n"
	         "Additionally, the text message content is included in the HTTP request body as text/plain if available.\n"
	         "\n"
	        ...
	        {String, "external-push-protocol",
	         "Protocol used for reaching external-push-uri, http2 or http (deprecated)", "http2"},
	        {DurationMIN, "register-wakeup-interval",
	         "Send service push notification periodically to all devices that are about to expire and should wake up "
	         "to "
