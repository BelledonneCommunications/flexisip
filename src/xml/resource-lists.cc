...
namespace Xsd
{
  namespace ResourceLists
  {
    ...
    DisplayNameType::
    DisplayNameType (const ::Xsd::XmlSchema::String& _xsd_String_base)
    : ::Xsd::XmlSchema::String (_xsd_String_base),
      lang_ (this)
    {
    }
    ...
    List (const List& x,
          ::Xsd::XmlSchema::Flags f,
          ::Xsd::XmlSchema::Container* c)
    : ::Xsd::ResourceLists::ListType (x, f, c)
    {
    }
    ...
    List (const ::xercesc::DOMElement& e,
          ::Xsd::XmlSchema::Flags f,
          ::Xsd::XmlSchema::Container* c)
    : ::Xsd::ResourceLists::ListType (e, f, c)
    {
    }
    ...
    DisplayName::
    DisplayName ()
    : ::Xsd::ResourceLists::DisplayNameType ()
    {
    }

    DisplayName::
    DisplayName (const char* _xsd_String_base)
    : ::Xsd::ResourceLists::DisplayNameType (_xsd_String_base)
    {
    }
    ...
    DisplayName (const DisplayName& x,
                 ::Xsd::XmlSchema::Flags f,
                 ::Xsd::XmlSchema::Container* c)
    : ::Xsd::ResourceLists::DisplayNameType (x, f, c)
    {
    }
    ...
    DisplayName (const ::xercesc::DOMElement& e,
                 ::Xsd::XmlSchema::Flags f,
                 ::Xsd::XmlSchema::Container* c)
    : ::Xsd::ResourceLists::DisplayNameType (e, f, c)
    {
    }
...
namespace Xsd
{
  namespace ResourceLists
  {
    ...
    {
      o << static_cast< const ::Xsd::ResourceLists::ListType& > (i);
    ...
    {
      o << static_cast< const ::Xsd::ResourceLists::DisplayNameType& > (i);
...
namespace Xsd
{
  namespace ResourceLists
  {
                        ...
                        const ::Xsd::XmlSchema::Properties& p)
    {
      ...
      return ::std::unique_ptr< ::Xsd::ResourceLists::ResourceLists > (
        ::Xsd::ResourceLists::parseResourceLists (
                        ...
                        const ::Xsd::XmlSchema::Properties& p)
    {
      ...
      return ::Xsd::ResourceLists::parseResourceLists (isrc, f, p);
    }
                        ...
                        const ::Xsd::XmlSchema::Properties& p)
    {
      ...
      ::xsd::cxx::xml::sax::std_input_source isrc (is);
      return ::Xsd::ResourceLists::parseResourceLists (isrc, h, f, p);
    }
                        ...
                        const ::Xsd::XmlSchema::Properties& p)
    {
      ...
      if (n.name () == "resource-lists" &&
          n.namespace_ () == "urn:ietf:params:xml:ns:resource-lists")
      {
        ::std::unique_ptr< ::Xsd::ResourceLists::ResourceLists > r (
          ::xsd::cxx::tree::traits< ::Xsd::ResourceLists::ResourceLists, char >::create (
            e, f, 0));
        return r;
      }
...
namespace Xsd
{
  namespace ResourceLists
  {
    ...
    serializeResourceLists (::std::ostream& o,
                            const ::Xsd::ResourceLists::ResourceLists& s,
                            ...
                            ::Xsd::XmlSchema::Flags f)
    {
      ...
      ::Xsd::XmlSchema::dom::unique_ptr< ::xercesc::DOMDocument > d (
        ::Xsd::ResourceLists::serializeResourceLists (s, m, f));
    ...
    serializeResourceLists (const ::Xsd::ResourceLists::ResourceLists& s,
                            const ::Xsd::XmlSchema::NamespaceInfomap& m,
                            ::Xsd::XmlSchema::Flags f)
    {
      ::Xsd::XmlSchema::dom::unique_ptr< ::xercesc::DOMDocument > d (
      ...
      ::Xsd::ResourceLists::serializeResourceLists (*d, s, f);
      return d;
    }
    ...
    {
      e << static_cast< const ::Xsd::ResourceLists::ListType& > (i);
    }

    void
    operator<< (::xercesc::DOMElement& e, const DisplayName& i)
    {
      e << static_cast< const ::Xsd::ResourceLists::DisplayNameType& > (i);
    }
