...
bool TelephoneEventFilter::onIncomingTransfer(uint8_t* data,
                                              size_t size,
                                              [[maybe_unused]] const struct sockaddr* sockaddr,
...
bool TelephoneEventFilter::onOutgoingTransfer([[maybe_unused]] uint8_t* data,
